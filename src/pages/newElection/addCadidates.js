...
const AddCandidates = ({ navigation }) => {
  return (
    <View style={styles.Container}>
      ...
      <View>
        <View style={styles.SearchBar}>
          <InputText icon="search" placeholder="Pesqusiar Candidato por NIF ou nome " />
        </View>
        <View style={{ paddingVertical: 20 }}>
          <SubTitle title="Selecionar candidatos" />
        </View>
      </View>
      ...
      <View style={{ height: 100,}}>
        <InputSubmit
          text="Proximo"
          onPress={() => navigation.navigate("AddVoter")}
        />
      </View>
    </View>
  );
